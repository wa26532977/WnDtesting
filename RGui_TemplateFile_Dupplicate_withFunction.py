...
class templateFile_Dupplicate_WithFunction(QDialog):
    def __init__(self):
        super(templateFile_Dupplicate_WithFunction, self).__init__()
        loadUi("RGui_TemplateFile_Dupplicate.ui", self)
    ...
    def OK_Pressed(self):
        ...
        while self.listWidget.currentItem() is None:
            ...
            return
        ui.duplicateNumber(self.listWidget.currentItem().text())
        self.close()
        ui.show()
        ui.exec_()
